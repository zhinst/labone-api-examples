...
Options:
    ...
    -s --awg_sourcefile       Specify an AWG sequencer file to compile and upload.
...
def run_example(device_id: str, awg_sourcefile: str = ""):
    ...
    err_msg = "This example can only be ran on either a UHFAWG, UHFQA or a UHF with the AWG option \
        enabled."
