...
Requirements:
    ...
    * Instruments:
        1 x SHFLI with AWG option installed and a loopback SMA cable between Signal Output 1 and Signal Input 1 of the device.
...
def run_example(
    ...
    device_settings = [
        (f"/{device_id}/synthesizers/0/centerfreq", 4e9),
        (f"/{device_id}/oscs/0/freq", 200e6),
        (f"/{device_id}/sigouts/0/generators/*/enable", 0),
        (f"/{device_id}/generators/3/oscselect", 0),
        (f"/{device_id}/sigouts/0/rfinterlock", 1),
        (f"/{device_id}/sigouts/0/range", 0),
        (f"/{device_id}/sigouts/0/on", 1),
        (f"/{device_id}/sigins/0/rfpath", 1),
        (f"/{device_id}/sigins/0/range", 0),
        (f"/{device_id}/sigins/0/on", 1),
        (f"/{device_id}/demods/0/adcselect", 0),
        (f"/{device_id}/demods/0/oscselect", 0),
        (f"/{device_id}/demods/0/phaseshift", 120),
