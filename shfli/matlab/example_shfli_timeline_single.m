...
%%% This example requires the SHFLI instrument and its AWG option to be installed on the device.
%%% A loopback SMA cable is required between Signal Output 1 and Signal Input 1 of the device.
